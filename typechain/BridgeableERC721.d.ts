...
interface BridgeableERC721Interface extends ethers.utils.Interface {
  functions: {
...
export class BridgeableERC721 extends BaseContract {
  ...
  interface: BridgeableERC721Interface;
